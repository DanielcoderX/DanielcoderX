...
### [`rustygo`](https://github.com/DanielcoderX/rustygo) — Low-level memory primitives for Go
> Rust-inspired arena allocation, object pools, and GC control — with zero-config defaults.  
> **0 B/op · 0 allocs/op** in benchmarks vs heap. Backed by `mmap` on Linux/macOS, `VirtualAlloc` on Windows.  
